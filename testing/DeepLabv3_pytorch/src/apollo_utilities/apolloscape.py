...
class Apolloscape(VisionDataset):
    ...
    classes = [
        ...
        ApolloScapeClass('rover', 1, 255, '其他', 0, False,
                         True, hex_to_rgb(0X000000)),
        ApolloScapeClass('sky', 17, 0, '天空', 1, False,
                         False, hex_to_rgb(0x4682B4)),
        ApolloScapeClass('car', 33, 1, '移动物体', 2, True,
                         False, hex_to_rgb(0x00008E)),
        ApolloScapeClass('car_groups', 161, 1, '移动物体',
                         2, True, False, hex_to_rgb(0x00008E)),
        ApolloScapeClass('motorbicycle', 34, 2, '移动物体',
                         2, True, False, hex_to_rgb(0x0000E6)),
        ApolloScapeClass('motorbicycle_group', 162, 2,
                         '移动物体', 2, True, False, hex_to_rgb(0x0000E6)),
        ApolloScapeClass('bicycle', 35, 3, '移动物体', 2, True,
                         False, hex_to_rgb(0x770B20)),
        ApolloScapeClass('bicycle_group', 163, 3, '移动物体',
                         2, True, False, hex_to_rgb(0x770B20)),
        ApolloScapeClass('person', 36, 4, '移动物体', 2, True,
                         False, hex_to_rgb(0x0080c0)),
        ApolloScapeClass('person_group', 164, 4, '移动物体',
                         2, True, False, hex_to_rgb(0x0080c0)),
        ApolloScapeClass('rider', 37, 5, '移动物体', 2, True,
                         False, hex_to_rgb(0x804080)),
        ApolloScapeClass('rider_group', 165, 5, '移动物体',
                         2, True, False, hex_to_rgb(0x804080)),
        ApolloScapeClass('truck', 38, 6, '移动物体', 2, True,
                         False, hex_to_rgb(0x8000c0)),
        ApolloScapeClass('truck_group', 166, 6, '移动物体',
                         2, True, False, hex_to_rgb(0x8000c0)),
        ApolloScapeClass('bus', 39, 7, '移动物体', 2, True,
                         False, hex_to_rgb(0xc00040)),
        ApolloScapeClass('bus_group', 167, 7, '移动物体',
                         2, True, False, hex_to_rgb(0xc00040)),
        ApolloScapeClass('tricycle', 40, 8, '移动物体', 2,
                         True, False, hex_to_rgb(0x8080c0)),
        ApolloScapeClass('tricycle_group', 168, 8, '移动物体',
                         2, True, False, hex_to_rgb(0x8080c0)),
        ApolloScapeClass('road', 49, 9, '平面', 3, False,
                         False, hex_to_rgb(0xc080c0)),
        ApolloScapeClass('siderwalk', 50, 10, '平面', 3,
                         False, False, hex_to_rgb(0xc08040)),
        ApolloScapeClass('traffic_cone', 65, 11, '路间障碍',
                         4, False, False, hex_to_rgb(0x000040)),
        ApolloScapeClass('road_pile', 66, 12, '路间障碍',
                         4, False, False, hex_to_rgb(0x0000c0)),
        ApolloScapeClass('fence', 67, 13, '路间障碍', 4, False,
                         False, hex_to_rgb(0x404080)),
        ApolloScapeClass('traffic_light', 81, 14, '路边物体',
                         5, False, False, hex_to_rgb(0xc04080)),
        ApolloScapeClass('pole', 82, 15, '路边物体', 5, False,
                         False, hex_to_rgb(0xc08080)),
        ApolloScapeClass('traffic_sign', 83, 16, '路边物体',
                         5, False, False, hex_to_rgb(0x004040)),
        ApolloScapeClass('wall', 84, 17, '路边物体', 5, False,
                         False, hex_to_rgb(0xc0c080)),
        ApolloScapeClass('dustbin', 85, 18, '路边物体', 5,
                         False, False, hex_to_rgb(0x4000c0)),
        ApolloScapeClass('billboard', 86, 19, '路边物体',
                         5, False, False, hex_to_rgb(0xc000c0)),
        ApolloScapeClass('building', 97, 20, '建筑', 6, False,
                         False, hex_to_rgb(0xc00080)),
        ApolloScapeClass('bridge', 98, 255, '建筑', 6, False,
                         True, hex_to_rgb(0x808000)),
        ApolloScapeClass('tunnel', 99, 255, '建筑', 6, False,
                         True, hex_to_rgb(0x800000)),
        ApolloScapeClass('overpass', 100, 255, '建筑', 6,
                         False, True, hex_to_rgb(0x408040)),
        ApolloScapeClass('vegatation', 113, 21, '自然',
                         7, False, False, hex_to_rgb(0x808040)),
        ApolloScapeClass('unlabeled', 255, 255, '未标注',
                         8, False, True, hex_to_rgb(0xFFFFFF)),
    ]
